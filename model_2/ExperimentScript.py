...
# Max simulation time:
AL.max_simulation_time_in_hours = 100
...
AL.buffering_enabled = False  #whether buffering is enabled
AL.double_buffering_enabled = False #use single buffering or double?
results=[]
#buffer_sizes= [4,8,16,32,64,128,256,512,1024]
buffer_sizes= [2]

results.insert(0,["N", "avg_throughput", "avg_cycle_time_hrs", "max_cycle_time_hrs", "avg_energy_per_PCB", "RFO_OFF", "RFO_setup", "RFO_ON_empty", "RFO_ON_occupied"])
