...
# as a dictionary.
#
def run_SMT_simulation(simulation_time, model_parameters):
...
def get_default_param_values():
    default_param_values = {'none':None}
    return default_param_values

if __name__ == '__main__':
    default_param_values = get_default_param_values() 
    simulation_time = 100
    results = run_SMT_simulation(simulation_time, default_param_values)
